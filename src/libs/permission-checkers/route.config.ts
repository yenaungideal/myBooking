...
export const ROUTE_PERMISSIONS: {[key:string]: IPermissionsConfig} = {
    '/dashboard': {userRoles: '*'},
    '/booking': {userRoles: [UserRoleIds.Admin,UserRoleIds.Staff]},
    '/users': {userRoles:[UserRoleIds.Admin],userPermissions:[UserPermissionIds.AddUser,UserPermissionIds.EditUser,UserPermissionIds.DeleteUser]},
